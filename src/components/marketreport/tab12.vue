  ...
  <div>
      ...
      <div class="pro-wrap">
          <p class="clearfix cms-title">
            ...
            <router-link class="right" v-if="!loading" style="color:#3079D5" :to="{name:'tab13x',params:{type:1,year:year,area:area}}">详细数据></router-link>

          </p>
          <template v-if="!loading">
            <div class="charts-rwap relative">
              <charts id="tab12-charts" styles="width:100%;height:19rem;margin:0 auto" :option="echartsOptions"></charts>
            </div>
          </template>
          <template v-else >
