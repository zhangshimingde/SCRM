...
<!--         <div class="search-content">
        ...
        <div class="res-list">
          <group  v-if="options.length>0">
            <checklist :options="options" label-position="left" v-if="count=='multiple'" v-model="value"></checklist>
            <checklist :options="options" label-position="left" v-else :max=1 v-model="value"></checklist>
          </group>
