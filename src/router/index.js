...
const newxs=resolve => require(['../view/fullpage/warn/newxs.vue'], resolve)
...
const yjsj=resolve => require(['../view/fullpage/warn/yjsj.vue'], resolve)
const zhsj=resolve => require(['../view/fullpage/warn/zhsj.vue'], resolve)
const zhxs=resolve => require(['../view/fullpage/warn/zhxs.vue'], resolve)


// 外部系统页面
const outSystem=resolve => require(['../view/fullpage/outSystem/outsystemwrap.vue'], resolve)
const analysisachiveOut=resolve => require(['../view/fullpage/outSystem/analysisachive.vue'], resolve)
...
{path:'/test',component: test,name:'test',meta:{title:"test"}},
          ...
          // 外部系统调用页面
          {path:'/outSystem',component: outSystem,name:'outSystem',children:[
            { path: 'analysisachiveOut', name: 'analysisachiveOut', component: analysisachiveOut ,meta:{title:"业绩分析"}}, //提供外部系统调用
            ]
          },
          ...
          {path:'/warnwrap',component: warnwrap,name:'warnwrap',children:[
            // // 转化(营销效能分析)
            //   {path:'zhsj/:title/:type/:id/:dateType',component: zhsj,name:'zhsj',meta:{title:""}},
            //   {path:'zhxs/:title/:type/:id/:dateType',component: zhxs,name:'zhxs',meta:{title:""}},
            // // 异常分析
            ...
            // 预警
              ...
              {path:'yjsj/:type',component: yjsj,name:'yjsj',meta:{title:"商机预警"}},
              ...
              { path: 'analysisachive', name: 'analysisachive', component: analysisachive ,meta:{title:"业绩分析"}},
							{ path: 'analysiseffect', name: 'analysiseffect', component: analysiseffect ,meta:{title:"营销效能分析",keepAlive: true}},
							{ path: 'analysiserror', name: 'analysiserror', component: analysiserror ,meta:{title:"异常分析",keepAlive: true}},
							{ path: 'analysissale', name: 'analysissale', component: analysissale ,meta:{title:"销售分析",keepAlive: true}},
              { path: 'marketreport', name: 'marketreport', component: marketreport ,meta:{title:"市场报表"}},

              // 转化(营销效能分析)
              {path:'zhsj/:title/:type/:id/:dateType/:date?',component: zhsj,name:'zhsj',meta:{title:""}},
              {path:'zhxs/:title/:type/:id/:dateType/:date?',component: zhxs,name:'zhxs',meta:{title:""}},
              // 异常分析穿透
              {path:'warnsj/:title/:type/:id/:date?',component: warnsj,name:'warnsj',meta:{title:""}},
              // {path:'warnxs/:title/:type/:id/:areaId/:date?',component: warnxs,name:'warnxs',meta:{title:""}},
              {path:'warnxs/:title/:type/:id/:date?',component: warnxs,name:'warnxs',meta:{title:""}},

              // 作为缓存组件穿透的详情页面(只改变路由即可实现，因为不跳出panelWrap，可以实现部分组件缓存)
              {path:'shangjidetail/:id/:sptype?',component: shangjidetail,name:'shangjidetailkeep',meta:{title:"商机详情",keepAlive: false}},
						]
					},
              ...
              {path:'newxs/:date?/:creater?/:product?/:area?/:status?',component: newxs,name:'newxs',meta:{title:"线索",keepAlive: true}},
