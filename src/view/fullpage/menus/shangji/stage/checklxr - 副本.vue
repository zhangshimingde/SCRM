<template>
    <div class="people-box-large">
      ...
      <div class="absolute com text_center clearfix">
        <!-- <div class="left" id="cancel" style="width:50%;background:#ccc" @click="cancel">取消</div> -->
        <div class="left" id="yes" style="width:100%" @click="comfirm">确定</div>
      </div>
      <!-- 弹出菜单 -->
      ...
      <div class="addlxr-wrap fixed" v-if="addlxr">
        <addlxr @cancel="addlxr=false" @add="add" :isScan="isScan"></addlxr>
      </div>
    </div>
</template>
...
import addlxr from '../../lianxiren/addlxr'
export default {
  name: '',
  components:{
    Search,Checklist,Group ,InlineLoading,menus,peopleset,addlxr
  },
  created(){
