<template>
    <div id="sjstage"  style="padding-bottom:3rem">
      ...
      <div class="stage-content relative" v-if="!loading">
        ...
        <tab4 v-show="index==4" :itemData="dataList[4]" @prev="prev" @next="next" @closeSj="closeSj"></tab4>
        <tab5 v-show="index==5" :itemData="dataList[5]" @prev="prev" @next="next" @closeSj="closeSj"></tab5>
...
import heads from "./stage/header"
import tab0 from "./stage/tab0"
import tab1 from "./stage/tab1"
import tab2 from "./stage/tab2"
import tab3 from "./stage/tab3"
import tab4 from "./stage/tab4"
import tab5 from "./stage/tab5"
export default {
  name: '',
  components:{
    ...
    getData(){  //获取商机状态
      ...
      .then((res)=>{
          ...
          switch(res.CurrentSate.StageGUID){
            ...
            case "01bd821c-613f-4502-9f65-a3475d7bfbc7": this.index=4;break;
            case "1a042316-2660-4581-9384-b1fc89878760": this.index=5;break;
          }
    ...
    prev(){  //返回上阶段
      if(this.index>0){
        ...
        switch(this.index){
            ...
            case 4: stageId="01bd821c-613f-4502-9f65-a3475d7bfbc7";break;
            case 5: stageId="1a042316-2660-4581-9384-b1fc89878760";break;
          }

        // console.log(stageId)
        if(this.index==4){  //从成交关闭返回上一阶段的时候，要清空合同
