<template>
            ...
            <swiper-item class="black">
              <div class="base-info-wrap text_center">
                ...
                <p class="kh text_center">
                    ...
                    <span  v-if="swiperInfo1.stage.indexOf('方案演示')>-1||swiperInfo1.stage.indexOf('商机激活')>-1||swiperInfo1.stage.indexOf('非成交关闭')>-1||swiperInfo1.stage.indexOf('确认中')>-1||swiperInfo1.stage.indexOf('待确认')>-1">{{swiperInfo1.stage}}</span>
                    <template v-else>
  ...
  <!-- 审批的按钮 -->
      ...
      <div class="sp-wrap clearfix fixed" v-if="sptype==1||sptype==3||sptype==5">
...
<script>
import { TransferDom,CellBox,Popup ,Group ,InlineLoading,Swiper,SwiperItem,Tab, TabItem,Scroller,Confirm   } from 'vux'
...
export default {
  name: '',
  components:{
   CellBox ,Group ,InlineLoading,Popup,Swiper,SwiperItem,Tab, TabItem,detail,checkpeoplemultiple,checkpeople,followrecord,Scroller,off,Confirm
  },
  created(){
      ...
      .then((res)=>{
        ...
        this.detailInfo=res.Data;
          ...
          this.getUserName(()=>{
            ...
            }else if(this.userName==this.detailInfo.OppInfo.ResponsibleCode&&(this.stageId=="0331623b-0075-4558-8e78-10b5ad482151"||this.stageId=="fd22139f-93f4-46a9-b51d-d3c60a4bf860"||this.stageId=="ffe49092-128e-4b37-8d94-e41fba1b271d")){//撤回(确认中，激活确认中，非成交关闭确认中商机)
