<template>
  <div id="kehu" class="fixed">
    <div class="header clearfix" id="kehusearch">
      <!-- <search ref="search" v-model="key" @on-submit="sub" :autoFixed="false"  placeholder="搜索客户"></search> -->
      <div class="left" style="width: 85%;">
        <search ref="search" v-model="key" @on-submit="sub" :autoFixed="false"  placeholder="搜索客户"></search>
      </div>
      <!-- <router-link :to="{name:'kehuadd'}" class="left text_center addsj  addkh" style="width:15%">
        <i class="iconfont icon-tianjia" style="font-size:1.5rem;color:#999"></i>
      </router-link> -->
      <span @click="kehuadd" class="left text_center addsj  addkh" style="width:15%">
        <i class="iconfont icon-tianjia" style="font-size:1.5rem;color:#999"></i>
      </span>
    </div>
    <div class="contents">
