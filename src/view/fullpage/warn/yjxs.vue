...
export default {
  ...
  created(){
    ...
    switch(this.$route.params.type){
      case 'UnassignedBy3Hour':document.title="三小时未指派";break;
      case 'UnassignedBy2Day':document.title="两天未指派";break;
      case 'UnassignedBy3Day':document.title="三天未指派";break;
      case 'UnassignedByOverTime':document.title="超时未指派";break;
      case 'NotFollowBy3Hour':document.title="三小时未跟进";break;
      case 'NotFollowBy2Day':document.title="两天未跟进";break;
      case 'NotFollowBy3Day':document.title="三天未跟进";break;
      case 'NotFollowByOverTime':document.title="超时未跟进";break;
      case 'NoValidityBy1Month':document.title="一个月未判断有效性";break;
      case 'NoValidityBy2Week':document.title="两周未判断有效性";break;
    }
