<template>
  <div id="shangji" class="" style="height:100vh;padding-top:44px;box-sizing:border-box">
        <div class="header clearfix">
          ...
          <router-link :to="{name:'kehuadd'}" class="left text_center addsj" style="width:15%;background:#F6F6F6">
        ...
        <div   v-if="$route.params.type!='我的关注'">
          <tab active-color="#0992FF"  bar-active-color="#0992FF">
            ...
            <tab-item :selected="indexTab==0" @on-item-click="indexTab=0">我的客户</tab-item>
            <tab-item :selected="indexTab==1" @on-item-click="indexTab=1">区域客户</tab-item>
            <tab-item :selected="indexTab==2" @on-item-click="indexTab=2">全国客户</tab-item>
          </tab>
        </div>
...
export default {
  ...
  data () {
    return {
      indexTab:this.$route.params.type!='我的关注'?0:2,
      khName:"",
      areaId:0,
      loading:false,
      loading2:true,
